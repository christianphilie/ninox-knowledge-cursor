...
**Grund**: Nur dokumentierte Funktionen verwenden. Siehe Forbidden Patterns
...
**Grund**: Ninox hat eigene Syntax. Siehe Forbidden Patterns
...
**Grund**: Undokumentierte Features müssen gekennzeichnet werden. Siehe Undocumented Features
...
- Performance-Regeln: Siehe wissen-05-performance.md
- Forbidden Patterns: Siehe wissen-03-forbidden-patterns.md
