...
2. ⚠️ Prüfe Undocumented Features - wenn verwendet, kennzeichnen
3. ❌ Prüfe Forbidden Patterns - keine erfundenen Funktionen/Syntax
...
1. **Zuerst**: In Function-Whitelist nachschauen
2. **Dann**: In Undocumented Features nachschauen
3. **Dann**: In Forbidden Patterns nachschauen
